  ...
  return (
    <>
      <div className="project">
        <div className="custom-shape-divider-top-1681580075">
          <svg
            data-name="Layer 1"
          ...
          <Card className="projectboxcard">
            ...
            <Card className="projectcard">
              <div className="projectdetails">
                ...
                <span className="projectdetailsbutton">
                  <a
                    href="https://reactcalculatorsapp.netlify.app/"
                    target="_blank"
            ...
            <Card className="projectcard">
              <div className="projectdetails">
                <span style={{ textAlign: "center" }}>Find Image Web App</span>
                <span className="projectdetailsbutton">
                  <a
                    href="https://find-any-image.netlify.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button>Demo</Button>
            ...
            <Card className="projectcard">
              <div className="projectdetails">
                <span style={{ textAlign: "center" }}>Porter Web App</span>
                <span className="projectdetailsbutton">
                  <a
              ...
              <div>
                <img width="180" height="180" alt="test" src={Porter} />{" "}
              </div>
            </Card>
